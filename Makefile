...
schemer: obj/Token.o obj/Parser.o obj/NativeFunctions.o obj/Interpreter.o obj/Value.o obj/main.o
	g++ obj/Token.o obj/Parser.o obj/NativeFunctions.o obj/Interpreter.o obj/Value.o obj/main.o  --std=c++0x -o schemer
clean:
	rm -f obj/* schemer
rebuild: clean all
